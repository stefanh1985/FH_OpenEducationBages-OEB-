...
__Entstehung und Verbreitung von Open Education Badges (OEB)__
Die Entwicklung der Open Education Badges (OEB) geht auf die Initiative der Mozilla Foundation gemeinsam mit der MacArthur Foundation im Jahr 2011 zurück. Ziel dieser Initiative war es, eine offene und vielseitige Methode bereitzustellen, mit der individuelle Lernprozesse und Leistungen digital dokumentiert und transparent geteilt werden können.
Seit der Einführung hat sich das Konzept weltweit etabliert und findet Anwendung in einer Vielzahl von Kontexten: von Bildungseinrichtungen über Unternehmen bis hin zu zivilgesellschaftlichen Organisationen. Der Erfolg dieses Modells zeigt, wie effektiv digitale Abzeichen als Instrument zur Anerkennung von Kompetenzen und zum Aufbau von Netzwerken genutzt werden können (vgl. Zander 2024)


# Für Lehrende und Studierende 🧑‍🏫&🧑‍🎓:Funktionsweise von Open Education Badges
Die Vergabe und Nutzung von Open Education Badges basiert auf einem strukturierten Prozess, der vier zentrale Schritte umfasst:
...
<div style="width:100%;height:0;padding-bottom:100%;position:relative;"><iframe src="https://giphy.com/embed/Dw5KfTzQWyOB5JPNkF" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/simax-avatar-deaf-dgs-Dw5KfTzQWyOB5JPNkF">via GIPHY</a></p>

__Praktische Anwendungsfelder von Open Education Badges (OEB)__

Open Education Badges (OEB) finden in einer Vielzahl von Kontexten Anwendung und tragen wesentlich zur Anerkennung von Lernleistungen und Kompetenzen bei. Sie ermöglichen es, formale und informelle Lernprozesse sichtbar und nachvollziehbar zu machen. Im Folgenden werden exemplarische Einsatzbereiche skizziert:

1. __Bildungswesen__

Schulen, Hochschulen und andere Bildungseinrichtungen setzen OEB ein, um individuelle Lernleistungen ihrer Schüler*innen und Studierenden zu dokumentieren. Diese reichen von formalen Qualifikationen wie Kursabschlüssen bis hin zu besonderen Projekten oder außercurricularem Engagement. Durch die Integration von Open Badges in Lernmanagementsysteme können Studierende ihre Kompetenzen digital und standardisiert nachweisen.

2. __Berufliche Weiterbildung__

Unternehmen nutzen OEB, um die berufliche Qualifikation und Entwicklung ihrer Mitarbeitenden zu zertifizieren. Dabei werden sowohl interne Weiterbildungsprogramme als auch externe Qualifizierungsmaßnahmen abgebildet. Open Badges bieten hier eine flexible Möglichkeit, berufliche Kompetenzen zu visualisieren und in Bewerbungskontexten oder Netzwerken wie LinkedIn zu teilen.

3. __Freiwilligenarbeit und gemeinnützige Organisationen__

OEB unterstützen die Anerkennung von Engagement und Leistungen, die Freiwillige in gemeinnützigen Projekten erbringen. Sie dokumentieren spezifische Fähigkeiten und Erfahrungen, die oft nicht über klassische Qualifikationsnachweise sichtbar gemacht werden können. Dadurch werden Freiwilligenarbeit und Ehrenämter stärker professionalisiert.

4. __Persönliche Entwicklung__

Individuen verwenden OEB, um ihre selbstständig erworbenen Kenntnisse und Fähigkeiten in verschiedenen Bereichen zu dokumentieren. Beispiele umfassen erfolgreich absolvierte Online-Kurse, Teilnahme an Workshops oder eigenständiges, projektbasiertes Lernen. OEB bieten eine Plattform, um den Lernprozess sichtbar zu machen und lebenslanges Lernen zu fördern.


# Für Lehrend 🧑‍🏫: technische Realisierung
<div style="width:100%;height:0;padding-bottom:100%;position:relative;"><iframe src="https://giphy.com/embed/26u49nPqBN5Is1SOk" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/br-game-26u49nPqBN5Is1SOk">via GIPHY</a></p>

Zur Realisierung von Open Badges im Sinne der Open Education Badges stehen verschieden Optionen zur Verfügung. An der PFH werden daher zwei Wege eingeschlagen die OEB zu erstellen und zu verteilen.

1. Weg 1 – Moodle	

2. Weg 2- https://openbadges.education/ 


## Für Lehrend 🧑‍🏫: technische Realisierung mittels Weg 1- Moodle
<div style="width:100%;height:0;padding-bottom:100%;position:relative;"><iframe src="https://giphy.com/embed/SZXUv9s3rvqdxXpyY1" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/stickers/anchietaportoalegre-transparent-SZXUv9s3rvqdxXpyY1">via GIPHY</a></p>
...
Gamification bezeichnet die Anwendung spieltypischer Elemente und Mechaniken in einem nicht-spielerischen Kontext, wie zum Beispiel der Lehre. Ziel ist es, Motivation, Engagement und Lernfortschritte zu fördern, indem Lernende durch Belohnungssysteme, Herausforderungen und spielerische Interaktionen angeregt werden.
<iframe width="560" height="315" src="https://www.youtube.com/embed/AHXNfa6HDXY?si=gcD5IbtFC4Ckvbxn" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### Entstehung und Entwicklung  
Der Begriff Gamification entstand um 2002 und erlangte ab 2010 größere Aufmerksamkeit, als Unternehmen und Bildungseinrichtungen begannen, spielerische Elemente in ihre Prozesse zu integrieren. Inspiriert von Videospielen, die Spieler*innen durch Levels, Punkte und Belohnungen motivieren, wurde diese Methode schnell auf andere Bereiche wie Marketing, Weiterbildung und das Bildungswesen übertragen.

### Nutzen von Gamification in der Lehre  
- **Motivation und Engagement**: Lernende fühlen sich stärker eingebunden und werden durch Belohnungen zu aktivem Lernen angeregt.  
- **Individualisierung**: Gamification ermöglicht es, Lernwege individuell anzupassen und Fortschritte sichtbar zu machen.  
- **Feedback**: Durch Mechanismen wie Punktesysteme oder Badges erhalten Lernende kontinuierliches Feedback zu ihren Leistungen.  
- **Förderung von Kompetenzen**: Kreativität, Problemlösungsfähigkeiten und Teamarbeit können durch spielerische Ansätze gestärkt werden.

### Badges als Gamification-Element in der Lehre  
Badges sind digitale Abzeichen, die spezifische Leistungen oder Fähigkeiten sichtbar machen. Sie können verwendet werden, um die Lehre zu gamifizieren, indem sie Lernende für folgende Aktivitäten belohnen:
- Das Absolvieren eines Moduls oder einer Aufgabe.  
- Die Teilnahme an Diskussionen oder Gruppenarbeiten.  
- Herausragende Leistungen wie kreative Beiträge oder kontinuierliches Engagement.

### Moodle, Gamification und Badges  
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/nknyIDnwNxw?si=8k8APGlE9n4LySww" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

📹Video: Kreuzworträtzel erstellen
<iframe width="560" height="315" src="https://www.youtube.com/embed/cqJ9iwq39gg?si=FrFiPgxLfjz6MW40" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### Fazit  
Gamification ist eine effektive Methode, um das Lernen an Hochschulen spannender und zugänglicher zu gestalten. Badges in Moodle bieten eine einfache und wirkungsvolle Möglichkeit, Gamification in die Lehre zu integrieren. Sie fördern die Motivation der Studierenden und stärken die Verbindung zwischen Lehrinhalten und praktischen Kompetenzen. Indem Sie spielerische Elemente einsetzen, können Sie nicht nur die Lernfreude steigern, sondern auch die Lernergebnisse nachhaltig verbessern.

## Badges in Moodle anlegen und Verwalten
Folgendes Video zeigt, wie Badges in Moodle angelegt und verwaltet werden. Im nächsten Schritt wird gezeigt, wie Badges erstellt werden können bevor sie ins Moodlesystem eingespielt werden.

<iframe width="560" height="315" src="https://www.youtube.com/embed/zLdNyBrtMFg?si=L2M4WxA8Fnm8xhOw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

📹 II: Badges ab Moodle 4.5
<iframe width="560" height="315" src="https://www.youtube.com/embed/LSIA5EOTrzw?si=xr1HKmkfveF7NRSC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

## Badges designen
<div style="width:100%;height:0;padding-bottom:100%;position:relative;"><iframe src="https://giphy.com/embed/26xBAcAeAQ2PmzQnS" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/happy-90s-fun-26xBAcAeAQ2PmzQnS">via GIPHY</a></p>
...
"Entwerfe ein digitales Badge für den Bildungsbereich, das folgende Anforderungen erfüllt:
    ...
    Zielgruppe: [Angabe der Zielgruppe, z. B. Schüler*innen, Studierende, Lehrkräfte]
...
## Für Lehrend 🧑‍🏫:Abfrage und Bedingungen zu Badges
...
Folgendes 📹 Video gibt eine Anleitung zur Regestrierung und Nutzung von Europass [youtube](<iframe width="560" height="315" src="https://www.youtube.com/embed/ZrTVuiNYcHI?si=odGKcl8_DMq0cxAl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>)
